...
<div class="wper-calendario">
  ...
  <?php
  $eventos_abiertos = array_filter( $eventos, function($e) { return $e->estado === 'abierto'; });
  $eventos_cerrados = array_filter( $eventos, function($e) { return $e->estado === 'cerrado'; });
  ?>
