        ...
        <div class="wper-cal-card wper-cal-<?php echo esc_attr($ev->estado); ?>">
          <?php if ($ev->cartel_url): ?>
            <div class="wper-cal-poster">
              <img src="<?php echo esc_url($ev->cartel_url); ?>" alt="<?php echo esc_attr($ev->nombre); ?>" class="wper-cal-poster-img">
            ...
            <div class="wper-cal-meta">
              ...
              <div class="wper-cal-meta-item">
                ...
                <?php if ($ev->google_maps): ?>
                  <a href="<?php echo esc_url($ev->google_maps); ?>" target="_blank" class="wper-btn-mini" title="<?php _e('Ver en Google Maps', 'wp-events-registration'); ?>">🗺️</a>
                <?php endif; ?>
              </div>
              <?php if ($rondas): ?>
              <div class="wper-cal-meta-item">
              ...
              <?php if ( ! empty( $ev->observaciones ) ) : ?>
                <div class="wper-cal-meta-item wper-cal-obs">
                  ...
                  <div class="wper-obs-content"><?php echo wp_kses_post( $ev->observaciones ); ?></div>
                </div>
              <?php endif; ?>
            </div>
