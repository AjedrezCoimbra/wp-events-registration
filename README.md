...
| Habilitar Inscripción Web | Si se desmarca, oculta el botón y el formulario de inscripción público |
...
CREATE TABLE {prefix}wper_eventos (
    ...
    permitir_inscripcion_web  TINYINT(1)       NOT NULL DEFAULT 1,
...
| Versión | Cambios |
|---|---|
| **2.0.3** | **NUEVA FUNCIONALIDAD**: Añadido check opcional para habilitar/deshabilitar temporalmente la inscripción web en eventos abiertos. · Ajustes internos: Requerimiento PHP 7.4 y testeo confirmado en WordPress 6.7. |
